...
// ============================================================
// Sensor enable switch
// センサー有効切り替え
// ------------------------------------------------------------
// 1 = Enable real sensors
//     実センサー使用
//
// 0 = Disable sensors
//     センサー無効
//
// When disabled, serial dummy data can be used.
// 無効時はシリアルダミーデータを使用可能
// ============================================================
...
// デフォルトアップロード先
// ----------------------------------------------------------
// Change this URL to your own web server
// このURLは自分のWebサーバーに変更してください
// ==========================================================
#define DEFAULT_UPLOAD_URL "http://example.com/weather/upload.php"

// ==========================================================
// Upload authentication key
// アップロード認証キー
// ----------------------------------------------------------
// Must match the $secret_key value in upload.php
// upload.php の $secret_key の値と一致させてください
// ==========================================================
#define DEFAULT_UPLOAD_KEY "test"
...
// ----------------------------------------------------------
// Static IP address for ESP32
// ESP32の固定IPアドレス
// ----------------------------------------------------------
// Make sure this address does not conflict with other devices
// 他の機器のIPアドレスと重複しないようにしてください
// ==========================================================
#define DEFAULT_LOCAL_IP   "192.168.1.252"

// ----------------------------------------------------------
// Network gateway address
// ネットワークゲートウェイアドレス
// ----------------------------------------------------------
// Usually the IP address of your WiFi router
// 通常はWiFiルーターのIPアドレスです
// ==========================================================
...
void handleRoot() {
  ...
  // HTMLテンプレート
  // ----------------------------------------------------------
  // Raw string literal allows multiline HTML
  // 生文字列を使って複数行HTMLを記述
  // ==========================================================
...
<div class="card">
  ...
  <!-- 日陰温度 -->
  <div>SHADE TEMP</div>
  <div class="big">%SHADE_TEMP% °C</div>

  <!-- Sunlight temperature -->
  <!-- 日向温度 -->
  <div class="item">SUN TEMP : %SUN_TEMP% °C</div>

  <!-- Humidity -->
  <!-- 湿度 -->
  <div class="item">HUMIDITY : %HUMIDITY% %</div>

  <!-- Atmospheric pressure -->
  <!-- 気圧 -->
  <div class="item">PRESSURE : %PRESSURE% hPa</div>
  ...
  html.replace("%SHADE_TEMP%", String(shadeTemp, 1));
  html.replace("%SUN_TEMP%",   String(sunTemp, 1));
  html.replace("%HUMIDITY%",   String(humidity, 1));
  html.replace("%PRESSURE%",   String(pressure, 1));
